...
/**
 * Created by Elvis on 08.10.2016.
 */
...
public class GameMines extends JFrame {
    ...
    final int FIELD_DY = 28 + 16;
    final int MOUSE_BUTTON_LEFT = 1;
    final int MOUSE_BUTTON_RIGHT = 3;
    final int NUMBER_OF_MINES = 10;
    final int[] COLOR_OF_NUMBERS = {0X000FF, 0X00800, 0XFF000, 0X0};
    ...
    GameMines() {
        ...
        setSize(FIELD_SIZE * BLOCK_SIZE + FIELD_DX, FIELD_SIZE * BLOCK_SIZE + FIELD_DY);
    ...
    void openCells(int x, int y) {                                          // recursive procedure of opening the cells
        ...
        field[y][x].open();
        if (field[y][x].getCountBombNear() > 0 || bangMine) {
